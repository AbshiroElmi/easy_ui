        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
          <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
            <div class="avatar avatar-online">
				{{ avatar }}
>>>>>>> 740c88c37ede407c4d60049c4be952a365b833d9
            </div>
            <div class="notification-list-body">
              <div class="panel-notifications"></div>
              <div class="panel-events"></div>
			...
			<div class="col-md-4 col-sm-6 col-xs-7 page-title">
				...
				<div class="flex fill-width title-area">
					<div>
						...
						<div class="ellipsis sub-heading hide1 text-muted"></div>
					</div>
    ...
    sidebar_item_container(item) {
      ...
      return $(`
			...
			<li class="menu-item ${item.selected ? "active" : ""}">
				<a href="/app/${item.public ? frappe.router.slug(item.title) : "private/" + frappe.router.slug(item.title)}" class="menu-link">
...
//# sourceMappingURL=easy.bundle.45G2CJJ3.js.map
